...
class SigningMode(Enum):
    ...
    # CHIP-0002 signs the result of sha256tree(cons("Flora Signed Message", message)) using the
    # BLS message augmentation scheme
    CHIP_0002 = "BLS_SIG_BLS12381G2_XMD:SHA-256_SSWU_RO_AUG:CHIP-0002_"

    # Standard BLS signatures used by Flora use the BLS message augmentation scheme
