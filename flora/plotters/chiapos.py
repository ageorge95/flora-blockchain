"""
NOTE: This contains duplicate code from `flora.cmds.plots`.
After `flora plots create` becomes obsolete, consider removing it from there.
"""
...
from flora.plotting.create_plots import create_plots, resolve_plot_keys
from flora.plotting.util import Params, add_plot_directory, validate_plot_size
...
def get_chiapos_install_info() -> Optional[Dict[str, Any]]:
    ...
    return {"display_name": "Flora Proof of Space", "version": chiapos_version, "installed": True}


def plot_flora(args, root_path):
    try:
