...
from flora.data_layer.data_layer_util import (
    CancelOfferRequest,
    CancelOfferResponse,
    MakeOfferRequest,
    MakeOfferResponse,
...
from flora.data_layer.data_layer_wallet import DataLayerWallet, Mirror, verify_offer
from flora.rpc.data_layer_rpc_util import marshal
from flora.rpc.rpc_server import Endpoint, EndpointResult
...
from flora.util.ws_message import WsRpcMessage
from flora.wallet.trading.offer import Offer as TradingOffer
...
class DataLayerRpcApi:
    ...
    def __init__(self, data_layer: DataLayer):  # , wallet: DataLayerWallet):
        ...
        self.service_name = "flora_data_layer"
