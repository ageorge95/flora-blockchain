...
from flora.data_layer.data_layer_wallet import Mirror, SingletonRecord
...
class WalletRpcClient(RpcClient):
    ...
    async def nft_mint_bulk(
        ...
        xfl_coins: Optional[List[Dict]] = None,
        xfl_change_target: Optional[str] = None,
        ...
        request = {
            ...
            "xfl_coins": xfl_coins,
            "xfl_change_target": xfl_change_target,
