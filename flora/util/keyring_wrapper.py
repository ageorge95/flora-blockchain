...
from flora.util.file_keyring import FileKeyring
...
# the new passphrase.
DEFAULT_PASSPHRASE_IF_NO_MASTER_PASSPHRASE = "$ flora passphrase set # all the cool kids are doing it!"

MASTER_PASSPHRASE_SERVICE_NAME = "Flora Passphrase"
MASTER_PASSPHRASE_USER_NAME = "Flora Passphrase"
...
class KeyringWrapper:
    ...
    def _get_initial_cached_passphrase(self) -> str:
        ...
        """
        from flora.util.keychain import supports_os_passphrase_storage
