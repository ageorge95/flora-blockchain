...
from flora.wallet.coin_selection import select_coins
from flora.wallet.derivation_record import DerivationRecord
from flora.wallet.derive_keys import master_sk_to_wallet_sk_unhardened
from flora.wallet.did_wallet import did_wallet_puzzles
from flora.wallet.did_wallet.did_info import DIDInfo
from flora.wallet.did_wallet.did_wallet_puzzles import uncurry_innerpuz
...
from flora.wallet.singleton import (
...
class DIDWallet:
    ...
    async def coin_added(self, coin: Coin, _: uint32, peer: WSFloraConnection):
    ...
    async def create_update_spend(self, fee: uint64 = uint64(0), reuse_puzhash: Optional[bool] = None):
        ...
        if flora_tx is not None and flora_tx.spend_bundle is not None:
            ...
            await self.wallet_state_manager.add_pending_transaction(flora_tx)
