...
from flora.types.blockchain_format.program import INFINITE_COST
...
There is also a provided NodeClient object which implements many of the methods from flora.rpc.full_node_rpc_client
