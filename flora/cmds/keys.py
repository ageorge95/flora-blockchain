...
@click.option(
    ...
    "-d",
    help=(
        "Show the first wallet address using non-observer derivation. Older Flora versions use "
...
@click.option("--prefix", "-x", help="Address prefix (xfl for mainnet, txfl for testnet)", default=None, type=str)
@click.pass_context
def search_cmd(
    ctx: click.Context,
