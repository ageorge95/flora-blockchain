...
from flora.util.config import load_defaults_for_missing_services, lock_and_load_config, save_config, str2bool
    ...
    with lock_and_load_config(root_path, config_yaml, fill_missing_services=True) as config:
        ...
        if testnet:
            if testnet == "true" or testnet == "t":
                ...
                testnet_port = "58444"
                testnet_introducer = "introducer-testnet10.flora.net"
                testnet_dns_introducer = "dns-introducer-testnet10.flora.net"
                bootstrap_peers = ["testnet10-node.flora.net"]
                testnet = "testnet10"
                ...
                mainnet_dns_introducer = "dns-introducer.flora.net"
                bootstrap_peers = ["node.flora.net"]
                net = "mainnet"
