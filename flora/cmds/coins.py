...
@click.option(
    ...
    "amounts_to_exclude",
    multiple=True,
    help="Exclude any coins with this XFL or CAT amount from being included.",
)
@click.option(
...
@click.option(
    "-a",
    "--target-amount",
    help="Select coins until this amount (in XFL or CAT) is reached. \
...
@click.option(
    "-a",
    "--amount-per-coin",
    help="The amount of each newly created coin, in XFL",
    type=str,
    required=True,
)
