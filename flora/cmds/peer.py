...
from flora.cmds.cmds_util import NODE_TYPES
from flora.cmds.peer_funcs import peer_async
...
@click.option("-a", "--add-connection", help="Connect specified Flora service to ip:port", type=str, default="")
@click.option(
