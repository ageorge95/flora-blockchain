...
from flora.util.collection import find_duplicates
from flora.util.db_synchronous import db_synchronous_on
from flora.util.db_wrapper import DBWrapper2, execute_fetchone
from flora.util.pprint import print_compact_ranges
...
help_text = """
\b
    The purpose of this command is find potential issues in Flora wallet databases.
    The core flora client currently uses sqlite to store the wallet databases, one database per key.
\b
