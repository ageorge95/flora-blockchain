...
from flora.plotting.util import add_plot_directory, validate_plot_size

log = logging.getLogger(__name__)


def show_plots(root_path: Path):
    from flora.plotting.util import get_plot_directories
...
def create_cmd(
    ...
    from flora.plotting.util import Params
...
def remove_cmd(ctx: click.Context, final_dir: str):
    from flora.plotting.util import remove_plot_directory
