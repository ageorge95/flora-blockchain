...
from flora.daemon.client import acquire_connection_to_daemon
from flora.util.errors import KeychainMaxUnlockAttempts
from flora.util.keychain import Keychain, supports_os_passphrase_storage
from flora.util.keyring_wrapper import DEFAULT_PASSPHRASE_IF_NO_MASTER_PASSPHRASE, KeyringWrapper
from flora.util.misc import prompt_yes_no
    ...
    try:
        if supports_os_passphrase_storage():
            ...
            print(
                ...
                "Other Flora processes will be able to access your keys without prompting for your passphrase."
            )
...
def read_passphrase_from_file(passphrase_file: TextIOWrapper) -> str:
    passphrase = passphrase_file.read().rstrip(os.environ.get("FLORA_PASSPHRASE_STRIP_TRAILING_CHARS", "\r\n"))
...
def initialize_passphrase() -> None:
    if Keychain.has_master_passphrase():
        ...
        print("\nUse 'flora passphrase set' or 'flora passphrase remove' to update or remove your passphrase")
        sys.exit(1)
